...
namespace JSar.Membership.Services.CommandHandlers
{
    public class RegisterLocalUserCommandHandler : CommandHandler<RegisterLocalUser, CommonResult>
    {
        ...
        {
            AppUser user = new AppUser(command.Email, command.FirstName, command.LastName, command.PrimaryPhone);
        ...
        {
            _logger.Error("Add local user command execution failed");
            ...
            CommonResult result = new CommonResult(
                ...
                "AddLocalUser command execution failed.",
                errorMessages.Count,
                errorMessages
                );
