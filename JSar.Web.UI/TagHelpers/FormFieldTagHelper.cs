...
namespace JSar.Web.UI.TagHelpers
{
    ...
    public class FormfieldTagHelper : TagHelper
    {
        ...
        // Default css
        // TODO: Allow override from a configuiration file
        private const string _defaultWraperDivClass = "form-group";
        private const string _defaultRowDivClass = "";
        private const string _defaultLabelClass = "form-label";
        private const string _defaultInputClass = "form-control";
        private const string _defaultInnerDivClass = "";
        private const string _defaultValidationMessageClass = "";
       
        public FormfieldTagHelper(IHtmlGenerator generator, ILogger logger)
        {
            Generator = generator;
            _logger = logger;
        }
