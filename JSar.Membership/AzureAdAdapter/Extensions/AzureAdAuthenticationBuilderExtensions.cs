...
namespace JSar.Membership.AzureAdAdapter.Extensions
{
            ...
            public void Configure(string name, OpenIdConnectOptions options)
            {
                ...
                options.Events = new OpenIdConnectEvents
                {
                    ...
                    OnAuthorizationCodeReceived = async (context) =>
                    {
                        ...
                        var identifier = context.Principal.FindFirst("http://schemas.microsoft.com/identity/claims/objectidentifier").Value;
                        ...
                        var currentTenantId = context.Principal.FindFirst("http://schemas.microsoft.com/identity/claims/tenantid").Value;
